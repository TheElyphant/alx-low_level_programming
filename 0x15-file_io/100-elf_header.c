...
/**
 * print_magic - Prints out the magic numbers of the ELF header.
 * @e_ident: Pointer to an array containing the ELF magic numbers.
...
/**
 * print_class - Prints out the class of the ELF header.
...
/**
 * print_data - Prints out data of the ELF header.
 * @e_ident: A pointer to an array containing the ELF class.
 */
void print_data(unsigned char *e_ident)
{
...
/**
 * main - This displays information
